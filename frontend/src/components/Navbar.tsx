...
const Navbar = ({ onConnectGitHub }: NavbarProps) => {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 flex justify-center px-4 pointer-events-none mt-4">
      <nav
      ...
      >
        ...
        <div className="flex items-center gap-2">
          <button className="md:hidden p-2 text-text-secondary hover:text-text-primary rounded-full hover:bg-surface-alt transition">
          ...
          <button
            ...
            className="bg-black hover:bg-slate-900 text-white rounded-full px-5 py-2 text-sm font-medium hover:scale-102 transition flex items-center space-x-2 cursor-pointer shadow-xs"
          >
